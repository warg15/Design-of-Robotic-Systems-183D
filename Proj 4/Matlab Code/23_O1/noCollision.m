function nc = noCollision(n2, n1, o)
    ...
    C1 = [obs(1),obs(2)];   D1 = [obs(1),obs(4)];
    C2 = [obs(1),obs(2)];   D2 = [obs(3),obs(2)];
    C3 = [obs(3),obs(4)];   D3 = [obs(3),obs(2)];
    C4 = [obs(3),obs(4)];   D4 = [obs(1),obs(4)];
    
    % Check if Edge(n1,n2) intersects edges of obstacles
